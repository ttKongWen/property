                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach var="repairInfoVo" items="${repairInfoVos}">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="/student/tobecanceled/${repairInfoVo.repair.id}/agree">同意</a>
                                </td>
                                <td>
                                    <a class="btn btn-warning" href="/student/tobecanceled/${repairInfoVo.repair.id}/reject">拒绝</a>
                                </td>

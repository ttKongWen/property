            ...
            <section class="content">
                ...
                <div class="content-text">
                    ...
                    <form class="form-horizontal" method="post" action="<c:url value="/admin/addstudent"/>"
                        ...
                        <fieldset>
                            <div id="legend" class="">
                                <legend class="">输入添加学生信息</legend>
                            </div>

                            <div class="layui-form-item">
                                <label for="name" class="layui-form-label" style="width:100px;">姓名：</label>
                                <div class="layui-input-block">
                                    <input name="name" class="layui-input" type="text" placeholder="学生姓名"  lay-verify="title">
                                </div>
                            </div>

                            <div class="layui-form-item">
                                <label for="email" class="layui-form-label" style="width:100px;">邮箱：</label>
                                <div class="layui-input-block">
                                    <input name="email" class="layui-input" type="text" placeholder="输入邮箱"  lay-verify="required">
                                </div>
                            </div>

                            <div class="layui-form-item">
                                <label for="password" class="layui-form-label" style="width:100px;">密码：</label>
                                <div class="layui-input-block">
                                    <input name="password" class="layui-input" type="text"  placeholder="输入密码"  lay-verify="title">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="sexual" class="layui-form-label" style="width:100px;">性别：</label>
                                <div class="layui-input-block">
                                    <input name="sexual" class="layui-input" type="text" placeholder="输入性别"  lay-verify="required">
                                </div>
                            </div>

                            <div class="layui-form-item">
                                <label for="phone" class="layui-form-label" style="width:100px;">电话：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="phone" placeholder="输入电话" class="layui-input" lay-verify="required">
                                </div>
                            </div>
